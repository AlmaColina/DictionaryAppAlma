...
class YellowColor : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun onCorrect(answer: String, classNum: Int){
            if (colors!![count] == answer){
                val intent = Intent(this@YellowColor, activitiesArray[classNum])
        ...
        restart.setOnClickListener {
            val intent = Intent(this@YellowColor, MainActivity::class.java)
            startActivity(intent)
        }
